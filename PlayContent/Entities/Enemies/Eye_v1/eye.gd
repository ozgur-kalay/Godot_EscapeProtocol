...
func look_left() -> void:
	...
	entity_detector_ray_cast_2d_group.look_left()
	$POVLight.look_left()
	$Heart.look_left()
...
func look_right() -> void:
	...
	$Sprite2D.look_at(global_position + Vector2.RIGHT)
	entity_detector_ray_cast_2d_group.look_right()
	$POVLight.look_right()
	$Heart.look_right()
...
func look_up() -> void:
	...
	$Sprite2D.flip_h = false
	entity_detector_ray_cast_2d_group.look_up()
	$POVLight.look_up()
	$Heart.look_up()
...
func look_down() -> void:
	...
	$Sprite2D.flip_h = false
	entity_detector_ray_cast_2d_group.look_down()
	$POVLight.look_down()
	$Heart.look_down()
